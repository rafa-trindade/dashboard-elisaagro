...
if 'data' in df.columns:
    ...
    if start_date and end_date:
        ...
        if start_date > end_date:
            ...
            sums = {
                "Fazenda": "<b>TOTAL</b>",
                "Café": "<b>"+str(data_frame["Café"].sum())+"</b>",
                "Almoço": "<b>"+str(data_frame["Almoço"].sum())+"</b>",
                "Lanche": "<b>"+str(data_frame["Lanche"].sum())+"</b>",
                "Janta": "<b>"+str(data_frame["Janta"].sum())+"</b>"
            }
            ...
            fig.update_layout(width=600, height=400,title={ 'text': "Demostrativo | Período", 'y':0.9, 'x':0.5, 'xanchor': 'center', 'yanchor': 'top'})
            ...
            fig_venda_fazenda.update_layout(width=600, height=400,title={ 'text': "Demostrativo/Fazenda | Período", 'y':0.90, 'x':0.4, 'xanchor': 'center', 'yanchor': 'top'})
        ...
        """, unsafe_allow_html=True)
            ...
            # Se a coluna 'data' não for do tipo datetime64, converta-a
            ...
            fig_venda_mes.update_layout(width=1000, height=600)
